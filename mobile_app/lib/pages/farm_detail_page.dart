...
<body>
  ...
  <script>
    ...
    const map = L.map('map', { zoomControl: false, maxZoom: 22 }).setView(center, $_mapZoom);

    // Tile Layer: Mapbox Satellite or Esri World Imagery Fallback with maxNativeZoom to allow deep zooming without missing tiles
    let satelliteLayer;
